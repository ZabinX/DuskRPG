...
public interface DuskProtocol {
	...
	public final static int FIELD_INFO_STRENGTH = 6;
	public final static int FIELD_INFO_STRENGTH_BONUS = 7;
	public final static int FIELD_INFO_INTELLIGENCE = 8;
	public final static int FIELD_INFO_INTELLIGENCE_BONUS = 9;
	public final static int FIELD_INFO_DEXTERITY = 10;
	public final static int FIELD_INFO_DEXTERITY_BONUS = 11;
	public final static int FIELD_INFO_CONSTITUTION = 12;
	public final static int FIELD_INFO_CONSTITUTION_BONUS = 13;
	public final static int FIELD_INFO_WISDOM = 14;
	public final static int FIELD_INFO_WISDOM_BONUS = 15;
	public final static int FIELD_INFO_DAMMOD = 16;
	public final static int FIELD_INFO_DAMMOD_BONUS = 17;
	public final static int FIELD_INFO_AC = 18;
	public final static int FIELD_INFO_AC_BONUS = 19;
	public final static int FIELD_ENTITY_ID = 0;
	public final static int FIELD_ENTITY_X = 1;
	public final static int FIELD_ENTITY_Y = 2;
	public final static int FIELD_ENTITY_TYPE = 3;
	public final static int FIELD_ENTITY_NAME = 4;
	public final static int FIELD_ENTITY_IMAGE = 5;
	/**
	 * MSG_INIT_MAP fields
	 */
	/**
	...
	// From wearing
	public final static int FIELD_WEARING_WIELD = 0;
	public final static int FIELD_WEARING_ARMS = 1;
	public final static int FIELD_WEARING_LEGS = 2;
	public final static int FIELD_WEARING_TORSO = 3;
	public final static int FIELD_WEARING_WAIST = 4;
	public final static int FIELD_WEARING_NECK = 5;
	public final static int FIELD_WEARING_SKULL = 6;
	public final static int FIELD_WEARING_EYES = 7;
	public final static int FIELD_WEARING_HANDS = 8;
	...
	public static final int TYPE_PLAYER_MERCHANT = 6;
