...
public class EntityUpdateMessage extends DuskMessage.EntityMessage {
	...
	public EntityUpdateMessage(DuskObject obj) {
		super(obj.ID, DuskProtocol.MSG_ADD_ENTITY);
		x = (short) obj.intLocX;
		y = (short) obj.intLocY;
		entityType = (byte) obj.getType();
		entityName = obj.strName;
		image = (short) obj.intImage;
	}
