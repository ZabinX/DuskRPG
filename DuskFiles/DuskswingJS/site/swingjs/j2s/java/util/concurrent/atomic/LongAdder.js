(function(){var P$=Clazz.newPackage("java.util.concurrent.atomic"),p$1={},p$2={},I$=[[0,'java.util.concurrent.atomic.LongAdder','java.util.concurrent.atomic.Striped64',['java.util.concurrent.atomic.LongAdder','.SerializationProxy']]],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var m;
var a;
if ((as=this.cells) != null  || !this.casBase$J$J(b=this.base, Long.$add(b,x)) ) {
var uncontended=true;
if (as == null  || (m=as.length - 1) < 0  || (a=as[$I$(2).getProbe$() & m]) == null   || !(uncontended=a.cas$J$J(v=a.value, Long.$add(v,x))) ) this.longAccumulate$J$java_util_function_LongBinaryOperator$Z(x, null, uncontended);
}});
...
if ((a=as[i]) != null ) (sum=Long.$add(sum,(a.value)));
}
}return sum;
});
...
return Long.$ival(this.sum$());
});

Clazz.newMeth(C$, 'floatValue$',  function () {
return Long.$fval(this.sum$());
});

Clazz.newMeth(C$, 'doubleValue$',  function () {
return Long.$dval(this.sum$());
});

Clazz.newMeth(C$, 'writeReplace',  function () {
return Clazz.new_($I$(3,1).c$$java_util_concurrent_atomic_LongAdder,[this]);
}, p$2);
