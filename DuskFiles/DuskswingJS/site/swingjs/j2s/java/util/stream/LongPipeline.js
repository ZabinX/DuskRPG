...
return $I$(3).collectLong$java_util_stream_PipelineHelper$java_util_Spliterator$Z(helper, spliterator, flattenTree);
});
...
return $I$(3).longBuilder$J(exactSizeIfKnown);
});

Clazz.newMeth(C$, 'iterator$',  function () {
return $I$(6,"iterator$java_util_Spliterator_OfLong",[this.spliterator$()]);
});
...
this.downstream.accept$D(Long.$dval(t));
});
})()
), Clazz.new_($I$(7,1).c$$java_util_stream_Sink,[this, null, sink],P$.LongPipeline$1$1));
});
})()
), Clazz.new_([this, null, this, $I$(2).LONG_VALUE, $I$(9).NOT_SORTED | $I$(9).NOT_DISTINCT],$I$(8,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$1));
});
...
/*lambda_M*/
Clazz.newMeth(C$, ['apply$J','apply$O'],  function (t) { return $$.valueOf$J.apply(null,[t])});
})()
...
Clazz.newMeth(C$, 'accept$J',  function (t) {
this.downstream.accept$J(this.$finals$.mapper.applyAsLong$J(t));
});
})()
), Clazz.new_($I$(7,1).c$$java_util_stream_Sink,[this, {mapper:this.$finals$.mapper}, sink],P$.LongPipeline$2$1));
});
})()
), Clazz.new_([this, {mapper:mapper}, this, $I$(2).LONG_VALUE, $I$(9).NOT_SORTED | $I$(9).NOT_DISTINCT],$I$(11,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$2));
});
...
Clazz.newMeth(C$, 'accept$J',  function (t) {
this.downstream.accept$O(this.$finals$.mapper.apply$J(t));
});
})()
), Clazz.new_($I$(7,1).c$$java_util_stream_Sink,[this, {mapper:this.$finals$.mapper}, sink],P$.LongPipeline$3$1));
});
})()
), Clazz.new_([this, {mapper:mapper}, this, $I$(2).LONG_VALUE, $I$(9).NOT_SORTED | $I$(9).NOT_DISTINCT],$I$(12,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$3));
});
...
Clazz.newMeth(C$, 'accept$J',  function (t) {
this.downstream.accept$I(this.$finals$.mapper.applyAsInt$J(t));
});
})()
), Clazz.new_($I$(7,1).c$$java_util_stream_Sink,[this, {mapper:this.$finals$.mapper}, sink],P$.LongPipeline$4$1));
});
})()
), Clazz.new_([this, {mapper:mapper}, this, $I$(2).LONG_VALUE, $I$(9).NOT_SORTED | $I$(9).NOT_DISTINCT],$I$(13,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$4));
});
...
Clazz.newMeth(C$, 'accept$J',  function (t) {
this.downstream.accept$D(this.$finals$.mapper.applyAsDouble$J(t));
});
})()
), Clazz.new_($I$(7,1).c$$java_util_stream_Sink,[this, {mapper:this.$finals$.mapper}, sink],P$.LongPipeline$5$1));
});
})()
), Clazz.new_([this, {mapper:mapper}, this, $I$(2).LONG_VALUE, $I$(9).NOT_SORTED | $I$(9).NOT_DISTINCT],$I$(8,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$5));
});
...
Clazz.newMeth(C$, 'accept$J',  function (t) {
try {
var result=this.$finals$.mapper.apply$J(t);
try {
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$J','accept$O'],  function (i) { return (this.b$['java.util.stream.LongPipeline$6$1'].downstream.accept$J.apply(this.b$['java.util.stream.LongPipeline$6$1'].downstream, [i]));});
})()
...
), Clazz.new_($I$(7,1).c$$java_util_stream_Sink,[this, {mapper:this.$finals$.mapper}, sink],P$.LongPipeline$6$1));
});
})()
), Clazz.new_([this, {mapper:mapper}, this, $I$(2).LONG_VALUE, $I$(9).NOT_SORTED | $I$(9).NOT_DISTINCT | $I$(9).NOT_SIZED ],$I$(11,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$6));
});
...
), Clazz.new_([this, null, this, $I$(2).LONG_VALUE, $I$(9).NOT_ORDERED],$I$(11,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$7));
});

Clazz.newMeth(C$, 'filter$java_util_function_LongPredicate',  function (predicate) {
$I$(10).requireNonNull$O(predicate);
...
Clazz.newMeth(C$, 'accept$J',  function (t) {
if (this.$finals$.predicate.test$J(t)) this.downstream.accept$J(t);
});
})()
), Clazz.new_($I$(7,1).c$$java_util_stream_Sink,[this, {predicate:this.$finals$.predicate}, sink],P$.LongPipeline$8$1));
});
})()
), Clazz.new_([this, {predicate:predicate}, this, $I$(2).LONG_VALUE, $I$(9).NOT_SIZED],$I$(11,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$8));
});

Clazz.newMeth(C$, 'peek$java_util_function_LongConsumer',  function (action) {
$I$(10).requireNonNull$O(action);
...
Clazz.newMeth(C$, 'accept$J',  function (t) {
this.$finals$.action.accept$J(t);
this.downstream.accept$J(t);
});
})()
), Clazz.new_($I$(7,1).c$$java_util_stream_Sink,[this, {action:this.$finals$.action}, sink],P$.LongPipeline$9$1));
});
})()
), Clazz.new_([this, {action:action}, this, $I$(2).LONG_VALUE, 0],$I$(11,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.LongPipeline$9));
});
...
return $I$(14).makeLong$java_util_stream_AbstractPipeline$J$J(this, 0, maxSize);
});
...
if (Long.$eq(n,0 )) return this;
 else return $I$(14).makeLong$java_util_stream_AbstractPipeline$J$J(this, n, -1);
});

Clazz.newMeth(C$, 'sorted$',  function () {
return $I$(15).makeLong$java_util_stream_AbstractPipeline(this);
});

Clazz.newMeth(C$, 'distinct$',  function () {
return this.boxed$().distinct$().mapToLong$java_util_function_ToLongFunction((P$.LongPipeline$lambda3$||(P$.LongPipeline$lambda3$=(((P$.LongPipeline$lambda3||
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.ToLongFunction', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsLong$Long','applyAsLong$O'],  function (i) { return ((i).valueOf());});
})()
), Clazz.new_(P$.LongPipeline$lambda3.$init$,[this, null]))))));
});

Clazz.newMeth(C$, 'forEach$java_util_function_LongConsumer',  function (action) {
this.evaluate$java_util_stream_TerminalOp($I$(16).makeLong$java_util_function_LongConsumer$Z(action, false));
});

Clazz.newMeth(C$, 'forEachOrdered$java_util_function_LongConsumer',  function (action) {
this.evaluate$java_util_stream_TerminalOp($I$(16).makeLong$java_util_function_LongConsumer$Z(action, true));
});

Clazz.newMeth(C$, 'sum$',  function () {
return this.reduce$J$java_util_function_LongBinaryOperator(0, (P$.LongPipeline$lambda4$||(P$.LongPipeline$lambda4$=((function($$){((
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.LongBinaryOperator', 1);
...
/*lambda_M*/
Clazz.newMeth(C$, ['applyAsLong$J$J','applyAsLong$O$O'],  function (t,u) { return $$.sum$J$J.apply(null,[t,u])});
})()
)); return Clazz.new_(P$.LongPipeline$lambda4.$init$,[this, null])})(Long)))));
});

Clazz.newMeth(C$, 'min$',  function () {
return this.reduce$java_util_function_LongBinaryOperator((P$.LongPipeline$lambda5$||(P$.LongPipeline$lambda5$=((function($$){((
...
/*lambda_M*/
Clazz.newMeth(C$, ['applyAsLong$J$J','applyAsLong$O$O'],  function (t,u) { return $$.min$J$J.apply(null,[t,u])});
})()
)); return Clazz.new_(P$.LongPipeline$lambda5.$init$,[this, null])})(Math)))));
});
...
/*lambda_M*/
Clazz.newMeth(C$, ['applyAsLong$J$J','applyAsLong$O$O'],  function (t,u) { return $$.max$J$J.apply(null,[t,u])});
})()
)); return Clazz.new_(P$.LongPipeline$lambda6.$init$,[this, null])})(Math)))));
});

Clazz.newMeth(C$, 'average$',  function () {
var avg=this.collect$java_util_function_Supplier$java_util_function_ObjLongConsumer$java_util_function_BiConsumer((P$.LongPipeline$lambda7$||(P$.LongPipeline$lambda7$=(((P$.LongPipeline$lambda7||
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Supplier', 1);
...
), Clazz.new_(P$.LongPipeline$lambda7.$init$,[this, null]))))), (P$.LongPipeline$lambda8$||(P$.LongPipeline$lambda8$=(((P$.LongPipeline$lambda8||
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda8", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.ObjLongConsumer', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$JA$J','accept$O$O'],  function (ll, i) {
(Clazz.incrAN(ll,0,1,false));
(ll[1]=Long.$add(ll[1],(i)));
});
})()
), Clazz.new_(P$.LongPipeline$lambda8.$init$,[this, null]))))), (P$.LongPipeline$lambda9$||(P$.LongPipeline$lambda9$=(((P$.LongPipeline$lambda9||
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda9", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.BiConsumer', 1);
...
), Clazz.new_(P$.LongPipeline$lambda9.$init$,[this, null]))))));
return Long.$gt(avg[0],0 ) ? $I$(17,"of$D",[Long.$dval(avg[1]) / avg[0]]) : $I$(17).empty$();
});

Clazz.newMeth(C$, 'count$',  function () {
return this.map$java_util_function_LongUnaryOperator((P$.LongPipeline$lambda10$||(P$.LongPipeline$lambda10$=(((P$.LongPipeline$lambda10||
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda10", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.LongUnaryOperator', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['applyAsLong$J','applyAsLong$O'],  function (e) { return (1);});
})()
), Clazz.new_(P$.LongPipeline$lambda10.$init$,[this, null])))))).sum$();
});

Clazz.newMeth(C$, 'summaryStatistics$',  function () {
return this.collect$java_util_function_Supplier$java_util_function_ObjLongConsumer$java_util_function_BiConsumer(((P$.LongPipeline$lambda11||
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda11", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Supplier', 1);
...
), Clazz.new_(P$.LongPipeline$lambda11.$init$,[this, null])), (function($$){((
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda12", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.ObjLongConsumer', 1);
...
/*lambda_M*/
Clazz.newMeth(C$, ['accept$O$J','accept$O$O'],  function (t,u) { return t.accept$J.apply(t,[u])});
})()
)); return Clazz.new_(P$.LongPipeline$lambda12.$init$,[this, null])})($I$(18)), (function($$){((
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda13", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.BiConsumer', 1);
...
/*lambda_M*/
Clazz.newMeth(C$, 'accept$O$O',  function (t,u) { return t.combine$java_util_LongSummaryStatistics.apply(t,[u])});
})()
)); return Clazz.new_(P$.LongPipeline$lambda13.$init$,[this, null])})($I$(18)));
});

Clazz.newMeth(C$, 'reduce$J$java_util_function_LongBinaryOperator',  function (identity, op) {
return (this.evaluate$java_util_stream_TerminalOp($I$(19).makeLong$J$java_util_function_LongBinaryOperator(identity, op))).valueOf();
});

Clazz.newMeth(C$, 'reduce$java_util_function_LongBinaryOperator',  function (op) {
return this.evaluate$java_util_stream_TerminalOp($I$(19).makeLong$java_util_function_LongBinaryOperator(op));
});
...
var operator=((P$.LongPipeline$lambda14||
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda14", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.BinaryOperator', 1);
...
), Clazz.new_(P$.LongPipeline$lambda14.$init$,[this, {combiner:combiner}]));
return this.evaluate$java_util_stream_TerminalOp($I$(19).makeLong$java_util_function_Supplier$java_util_function_ObjLongConsumer$java_util_function_BinaryOperator(supplier, accumulator, operator));
});

Clazz.newMeth(C$, 'anyMatch$java_util_function_LongPredicate',  function (predicate) {
return (this.evaluate$java_util_stream_TerminalOp($I$(20,"makeLong$java_util_function_LongPredicate$java_util_stream_MatchOps_MatchKind",[predicate, $I$(21).ANY]))).valueOf();
});

Clazz.newMeth(C$, 'allMatch$java_util_function_LongPredicate',  function (predicate) {
return (this.evaluate$java_util_stream_TerminalOp($I$(20,"makeLong$java_util_function_LongPredicate$java_util_stream_MatchOps_MatchKind",[predicate, $I$(21).ALL]))).valueOf();
});

Clazz.newMeth(C$, 'noneMatch$java_util_function_LongPredicate',  function (predicate) {
return (this.evaluate$java_util_stream_TerminalOp($I$(20,"makeLong$java_util_function_LongPredicate$java_util_stream_MatchOps_MatchKind",[predicate, $I$(21).NONE]))).valueOf();
});

Clazz.newMeth(C$, 'findFirst$',  function () {
return this.evaluate$java_util_stream_TerminalOp($I$(22).makeLong$Z(true));
});

Clazz.newMeth(C$, 'findAny$',  function () {
return this.evaluate$java_util_stream_TerminalOp($I$(22).makeLong$Z(false));
});

Clazz.newMeth(C$, 'toArray$',  function () {
return $I$(3,"flattenLong$java_util_stream_Node_OfLong",[this.evaluateToArrayNode$java_util_function_IntFunction(((P$.LongPipeline$lambda15||
(function(){/*m*/var C$=Clazz.newClass(P$, "LongPipeline$lambda15", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.IntFunction', 1);
...
), Clazz.new_(P$.LongPipeline$lambda15.$init$,[this, null])))]).asPrimitiveArray$();
});
;
...
Clazz.newMeth(C$, 'forEach$java_util_function_LongConsumer',  function (action) {
if (!this.isParallel$()) {
$I$(1,"adapt$java_util_Spliterator",[this.sourceStageSpliterator$()]).forEachRemaining$java_util_function_LongConsumer(action);
} else {
