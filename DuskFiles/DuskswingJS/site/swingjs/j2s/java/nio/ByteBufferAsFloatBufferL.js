(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.ByteBufferAsFloatBufferRL','java.nio.Bits','java.nio.ByteOrder']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "ByteBufferAsFloatBufferL", null, 'java.nio.FloatBuffer');
...
return $I$(2,"getFloatL$java_nio_ByteBuffer$I",[this.bb, this.ix$I(this.nextGetIndex$())]);
});

Clazz.newMeth(C$, 'get$I',  function (paramInt) {
return $I$(2,"getFloatL$java_nio_ByteBuffer$I",[this.bb, this.ix$I(this.checkIndex$I(paramInt))]);
});

Clazz.newMeth(C$, 'put$F',  function (paramFloat) {
$I$(2,"putFloatL$java_nio_ByteBuffer$I$F",[this.bb, this.ix$I(this.nextPutIndex$()), paramFloat]);
return this;
});

Clazz.newMeth(C$, 'put$I$F',  function (paramInt, paramFloat) {
$I$(2,"putFloatL$java_nio_ByteBuffer$I$F",[this.bb, this.ix$I(this.checkIndex$I(paramInt)), paramFloat]);
return this;
});
