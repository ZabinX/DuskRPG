(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.ByteBufferAsDoubleBufferRL','java.nio.Bits','java.nio.ByteOrder']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "ByteBufferAsDoubleBufferL", null, 'java.nio.DoubleBuffer');
...
return $I$(2,"getDoubleL$java_nio_ByteBuffer$I",[this.bb, this.ix$I(this.nextGetIndex$())]);
});

Clazz.newMeth(C$, 'get$I',  function (paramInt) {
return $I$(2,"getDoubleL$java_nio_ByteBuffer$I",[this.bb, this.ix$I(this.checkIndex$I(paramInt))]);
});

Clazz.newMeth(C$, 'put$D',  function (paramDouble) {
$I$(2,"putDoubleL$java_nio_ByteBuffer$I$D",[this.bb, this.ix$I(this.nextPutIndex$()), paramDouble]);
return this;
});

Clazz.newMeth(C$, 'put$I$D',  function (paramInt, paramDouble) {
$I$(2,"putDoubleL$java_nio_ByteBuffer$I$D",[this.bb, this.ix$I(this.checkIndex$I(paramInt)), paramDouble]);
return this;
});
