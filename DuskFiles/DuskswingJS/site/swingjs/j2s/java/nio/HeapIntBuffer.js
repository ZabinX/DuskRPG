(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.HeapIntBufferR','java.nio.Buffer','java.nio.ByteOrder']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "HeapIntBuffer", null, 'java.nio.IntBuffer');
...
;C$.superclazz.c$$I$I$I$I$IA$I.apply(this,[-1, 0, lim, cap, Clazz.array(Integer.TYPE, [cap]), 0]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$IA$I$I',  function (buf, off, len) {
;C$.superclazz.c$$I$I$I$I$IA$I.apply(this,[-1, off, off + len, buf.length, buf, 0]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$IA$I$I$I$I$I',  function (buf, mark, pos, lim, cap, off) {
;C$.superclazz.c$$I$I$I$I$IA$I.apply(this,[mark, pos, lim, cap, buf, off]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'slice$',  function () {
return Clazz.new_(C$.c$$IA$I$I$I$I$I,[this.hb, -1, 0, this.remaining$(), this.remaining$(), this.position$() + this.offset]);
});

Clazz.newMeth(C$, 'duplicate$',  function () {
return Clazz.new_(C$.c$$IA$I$I$I$I$I,[this.hb, this.markValue$(), this.position$(), this.limit$(), this.capacity$(), this.offset]);
});

Clazz.newMeth(C$, 'asReadOnlyBuffer$',  function () {
return Clazz.new_([this.hb, this.markValue$(), this.position$(), this.limit$(), this.capacity$(), this.offset],$I$(1,1).c$$IA$I$I$I$I$I);
});
...
Clazz.newMeth(C$, 'get$IA$I$I',  function (dst, offset, length) {
...
Clazz.newMeth(C$, 'put$I',  function (x) {
this.hb[this.ix$I(this.nextPutIndex$())]=x;
return this;
});

Clazz.newMeth(C$, 'put$I$I',  function (i, x) {
this.hb[this.ix$I(this.checkIndex$I(i))]=x;
return this;
});

Clazz.newMeth(C$, 'put$IA$I$I',  function (src, offset, length) {
...
Clazz.newMeth(C$, 'put$java_nio_IntBuffer',  function (src) {
if (Clazz.instanceOf(src, "java.nio.HeapIntBuffer")) {
...
var n=src.remaining$();
if (n > this.remaining$()) throw Clazz.new_(Clazz.load('java.nio.BufferOverflowException'));
src.get$IA$I$I(this.hb, this.ix$I(this.position$()), n);
this.position$I(this.position$() + n);
} else {
C$.superclazz.prototype.put$java_nio_IntBuffer.apply(this, [src]);
}return this;
});
