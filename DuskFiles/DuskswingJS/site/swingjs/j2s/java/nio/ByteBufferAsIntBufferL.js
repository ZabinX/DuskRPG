(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.ByteBufferAsIntBufferRL','java.nio.Bits','java.nio.ByteOrder']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "ByteBufferAsIntBufferL", null, 'java.nio.IntBuffer');
...
return $I$(2,"getIntL$java_nio_ByteBuffer$I",[this.bb, this.ix$I(this.nextGetIndex$())]);
});

Clazz.newMeth(C$, 'get$I',  function (paramInt) {
return $I$(2,"getIntL$java_nio_ByteBuffer$I",[this.bb, this.ix$I(this.checkIndex$I(paramInt))]);
});

Clazz.newMeth(C$, 'put$I',  function (paramInt) {
$I$(2,"putIntL$java_nio_ByteBuffer$I$I",[this.bb, this.ix$I(this.nextPutIndex$()), paramInt]);
return this;
});

Clazz.newMeth(C$, 'put$I$I',  function (paramInt1, paramInt2) {
$I$(2,"putIntL$java_nio_ByteBuffer$I$I",[this.bb, this.ix$I(this.checkIndex$I(paramInt1)), paramInt2]);
return this;
});
