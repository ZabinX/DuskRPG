(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.HeapDoubleBufferR','java.nio.Buffer','java.nio.ByteOrder']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "HeapDoubleBuffer", null, 'java.nio.DoubleBuffer');
...
;C$.superclazz.c$$I$I$I$I$DA$I.apply(this,[-1, 0, lim, cap, Clazz.array(Double.TYPE, [cap]), 0]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$DA$I$I',  function (buf, off, len) {
;C$.superclazz.c$$I$I$I$I$DA$I.apply(this,[-1, off, off + len, buf.length, buf, 0]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$DA$I$I$I$I$I',  function (buf, mark, pos, lim, cap, off) {
;C$.superclazz.c$$I$I$I$I$DA$I.apply(this,[mark, pos, lim, cap, buf, off]);C$.$init$.apply(this);
}, 1);
...
return Clazz.new_([this.hb, this.markValue$(), this.position$(), this.limit$(), this.capacity$(), this.offset],$I$(1,1).c$$DA$I$I$I$I$I);
});
