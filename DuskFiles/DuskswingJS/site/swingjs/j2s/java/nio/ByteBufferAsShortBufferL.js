(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.ByteBufferAsShortBufferRL','java.nio.Bits','java.nio.ByteOrder']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "ByteBufferAsShortBufferL", null, 'java.nio.ShortBuffer');
...
return $I$(2,"getShortL$java_nio_ByteBuffer$I",[this.bb, this.ix$I(this.nextGetIndex$())]);
});

Clazz.newMeth(C$, 'get$I',  function (paramInt) {
return $I$(2,"getShortL$java_nio_ByteBuffer$I",[this.bb, this.ix$I(this.checkIndex$I(paramInt))]);
});

Clazz.newMeth(C$, 'put$H',  function (paramShort) {
$I$(2,"putShortL$java_nio_ByteBuffer$I$H",[this.bb, this.ix$I(this.nextPutIndex$()), paramShort]);
return this;
});

Clazz.newMeth(C$, 'put$I$H',  function (paramInt, paramShort) {
$I$(2,"putShortL$java_nio_ByteBuffer$I$H",[this.bb, this.ix$I(this.checkIndex$I(paramInt)), paramShort]);
return this;
});
