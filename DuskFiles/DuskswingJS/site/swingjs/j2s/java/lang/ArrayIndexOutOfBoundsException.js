...
/*c*/var C$=Clazz.newClass(P$, "ArrayIndexOutOfBoundsException", null, 'IndexOutOfBoundsException');
...
;C$.superclazz.c$$S.apply(this,["Array index out of range: " + index]);C$.$init$.apply(this);
}, 1);
