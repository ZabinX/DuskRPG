...
/*c*/var C$=Clazz.newClass(P$, "StringIndexOutOfBoundsException", null, 'IndexOutOfBoundsException');
...
;C$.superclazz.c$$S.apply(this,["String index out of range: " + index]);C$.$init$.apply(this);
}, 1);
