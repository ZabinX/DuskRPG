(function(){var P$=Clazz.newPackage("swingjs.image"),I$=[[0,'swingjs.image.GifImageWriteParam']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "GifImageWriter", null, 'swingjs.image.JSImageWriter');
