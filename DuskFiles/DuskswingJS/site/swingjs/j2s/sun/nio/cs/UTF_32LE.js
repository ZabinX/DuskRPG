...
/*c*/var C$=Clazz.newClass(P$, "UTF_32LE", null, 'sun.nio.cs.Unicode');
...
;C$.superclazz.c$$S$SA.apply(this,["UTF-32LE", $I$(1).aliases_UTF_32LE]);C$.$init$.apply(this);
}, 1);
...
return Clazz.new_($I$(3,1).c$$java_nio_charset_Charset$I$Z,[this, 2, false]);
});
})();
