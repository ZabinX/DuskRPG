...
/*c*/var C$=Clazz.newClass(P$, "ShortComponentRaster", null, 'sun.awt.image.SunWritableRaster');
...
C$.$fields$=[['I',['bandOffset','scanlineStride','pixelStride','type','maxX','maxY'],'O',['dataOffsets','int[]','data','short[]']]]

Clazz.newMeth(C$, 'c$$java_awt_image_SampleModel$java_awt_Point',  function (sampleModel, origin) {
C$.c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_ShortComponentRaster.apply(this, [sampleModel, sampleModel.createDataBuffer$(), Clazz.new_([origin.x, origin.y, sampleModel.getWidth$(), sampleModel.getHeight$()],$I$(1,1).c$$I$I$I$I), origin, null]);
}, 1);
...
C$.c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_ShortComponentRaster.apply(this, [sampleModel, dataBuffer, Clazz.new_([origin.x, origin.y, sampleModel.getWidth$(), sampleModel.getHeight$()],$I$(1,1).c$$I$I$I$I), origin, null]);
}, 1);

Clazz.newMeth(C$, 'c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_ShortComponentRaster',  function (sampleModel, dataBuffer, aRegion, origin, parent) {
...
throw Clazz.new_(Clazz.load('java.awt.image.RasterFormatException').c$$S,["ShortComponentRasters must have short DataBuffers"]);
}var dbus=dataBuffer;
this.data=$I$(2).stealData$java_awt_image_DataBufferUShort$I(dbus, 0);
if (dbus.getNumBanks$() != 1) {
throw Clazz.new_(Clazz.load('java.awt.image.RasterFormatException').c$$S,["DataBuffer for ShortComponentRasters must only have 1 bank."]);
}var dbOffset=dbus.getOffset$();
...
throw Clazz.new_(Clazz.load('java.awt.image.RasterFormatException').c$$S,["ShortComponentRasters must haveComponentSampleModel or SinglePixelPackedSampleModel"]);
...
var deltaX=x0 - x;
var deltaY=y0 - y;
return Clazz.new_(C$.c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_ShortComponentRaster,[sm, this.dataBuffer, Clazz.new_($I$(1,1).c$$I$I$I$I,[x0, y0, width, height]), Clazz.new_($I$(3,1).c$$I$I,[this.sampleModelTranslateX + deltaX, this.sampleModelTranslateY + deltaY]), this]);
});
...
return  String.instantialize("ShortComponentRaster: width = " + this.width + " height = " + this.height + " #numDataElements " + this.numDataElements );
});
