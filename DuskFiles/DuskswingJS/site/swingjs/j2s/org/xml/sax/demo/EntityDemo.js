(function(){var P$=Clazz.newPackage("org.xml.sax.demo"),I$=[[0,'java.io.StringReader','org.xml.sax.helpers.ParserFactory','org.xml.sax.InputSource','java.net.URL']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
