(function(){var P$=Clazz.newPackage("com.jcraft.jzlib"),I$=[[0,'com.jcraft.jzlib.InfTree','com.jcraft.jzlib.InfCodes']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
this.inftree=Clazz.new_(Clazz.load('com.jcraft.jzlib.InfTree'));
}, 1);

Clazz.newMeth(C$, 'c$$com_jcraft_jzlib_ZStream$I', function (z, w) {
C$.$init$.apply(this);
this.z=z;
this.codes=Clazz.new_(Clazz.load('com.jcraft.jzlib.InfCodes').c$$com_jcraft_jzlib_ZStream$com_jcraft_jzlib_InfBlocks,[this.z, this]);
...
if (this.mode == 6) {
this.codes.free$com_jcraft_jzlib_ZStream(this.z);
}this.mode=0;
this.bitk=0;
this.bitb=0;
...
break;
case 1:
$I$(1).inflate_trees_fixed$IA$IA$IAA$IAA$com_jcraft_jzlib_ZStream(this.bl, this.bd, this.tl, this.td, this.z);
...
this.bb[0]=7;
t=this.inftree.inflate_trees_bits$IA$IA$IA$IA$com_jcraft_jzlib_ZStream(this.blens, this.bb, this.tb, this.hufts, this.z);
if (t != 0) {
r=t;
if (r == -3) {
this.blens=null;
...
this.bd[0]=6;
t=this.table;
t=this.inftree.inflate_trees_dynamic$I$I$IA$IA$IA$IA$IA$IA$com_jcraft_jzlib_ZStream(257 + (t & 31), 1 + ((t >> 5) & 31), this.blens, this.bl, this.bd, this.tli, this.tdi, this.hufts, this.z);
if (t != 0) {
if (t == -3) {
this.blens=null;
this.mode=9;
