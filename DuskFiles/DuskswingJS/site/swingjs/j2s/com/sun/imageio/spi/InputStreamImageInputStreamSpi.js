(function(){var P$=Clazz.newPackage("com.sun.imageio.spi"),I$=[[0,'java.io.InputStream','javax.imageio.stream.FileCacheImageInputStream','javax.imageio.stream.MemoryCacheImageInputStream']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
