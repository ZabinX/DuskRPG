(function(){var P$=Clazz.newPackage("javax.xml.datatype"),I$=[[0,'java.util.Properties','javax.xml.datatype.SecuritySupport',['javax.xml.datatype.FactoryFinder','.ConfigurationError'],'java.io.File']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[[]
,['Z',['debug','firstTime'],'O',['cacheProps','java.util.Properties','ss','javax.xml.datatype.SecuritySupport']]]
