(function(){var P$=Clazz.newPackage("javax.xml.parsers"),I$=[[0,'java.util.Properties','javax.xml.parsers.SecuritySupport',['javax.xml.parsers.FactoryFinder','.ConfigurationError'],'java.io.File']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[[]
,['Z',['debug','firstTime'],'O',['cacheProps','java.util.Properties','ss','javax.xml.parsers.SecuritySupport']]]
...
return C$.newInstance$S$ClassLoader$Z$Z(className, cl, doFallback, false);
}, 1);

Clazz.newMeth(C$, 'newInstance$S$ClassLoader$Z$Z',  function (className, cl, doFallback, useBSClsLoader) {
try {
...
return C$.newInstance$S$ClassLoader$Z(fallbackClassName, null, true);
}, 1);
