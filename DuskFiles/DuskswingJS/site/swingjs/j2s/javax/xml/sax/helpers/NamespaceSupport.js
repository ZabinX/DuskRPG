(function(){var P$=Clazz.newPackage("javax.xml.sax.helpers"),p$1={},I$=[[0,'java.util.Vector','javax.xml.sax.helpers.NamespaceSupport','java.util.Hashtable',['javax.xml.sax.helpers.NamespaceSupport','.Context']]],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['namespaceDeclUris'],'I',['contextPos'],'O',['contexts','javax.xml.sax.helpers.NamespaceSupport.Context[]','currentContext','javax.xml.sax.helpers.NamespaceSupport.Context']]
...
C$.$fields$=[['Z',['declsOK','declSeen'],'S',['defaultNS'],'O',['prefixTable','java.util.Hashtable','+uriTable','+elementNameTable','+attributeNameTable','declarations','java.util.Vector','parent','javax.xml.sax.helpers.NamespaceSupport.Context']]]
...
if (index == -1) {
if (isAttribute) {
if (qName === "xmlns"  && this.b$['javax.xml.sax.helpers.NamespaceSupport'].namespaceDeclUris ) name[0]="http://www.w3.org/xmlns/2000/";
 else name[0]="";
