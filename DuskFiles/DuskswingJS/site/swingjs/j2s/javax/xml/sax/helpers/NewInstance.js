(function(){var P$=Clazz.newPackage("javax.xml.sax.helpers"),I$=[[0,'Thread','UnknownError']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var m=null;
try {
m=Clazz.getClass($I$(1)).getMethod$S$ClassA("getContextClassLoader", Clazz.array(Class, -1, []));
} catch (e) {
