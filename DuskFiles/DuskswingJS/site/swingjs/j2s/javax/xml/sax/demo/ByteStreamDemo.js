(function(){var P$=Clazz.newPackage("javax.xml.sax.demo"),I$=[[0,'javax.xml.sax.helpers.ParserFactory','javax.xml.sax.demo.DemoHandler','java.io.FileInputStream','javax.xml.sax.InputSource']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
