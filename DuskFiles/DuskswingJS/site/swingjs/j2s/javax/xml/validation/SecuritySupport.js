(function(){var P$=Clazz.newPackage("javax.xml.validation"),I$=[[0,'java.security.AccessController','Thread','java.io.FileInputStream']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
