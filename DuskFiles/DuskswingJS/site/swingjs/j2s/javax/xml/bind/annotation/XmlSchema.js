(function(){var P$=Clazz.newPackage("javax.xml.bind.annotation"),I$=[[0,'javax.xml.bind.annotation.XmlNs','javax.xml.bind.annotation.XmlNsForm']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
