	...
	*/
	...
	public void updateMap()
	{
		try {
			...
			send(new MapMessage(DuskProtocol.MSG_MAP, viewWidth, viewHeight, map, mapAlpha, mapAlpha2));
		} catch (Exception e) {
	...
	public void chatMessage(String inMessage)
	{
		...
		if (isPlayer())
		{
			send(new DuskMessage.StringMessage(DuskProtocol.MSG_CHAT, inMessage));
		}
		if (thnCharmer != null)
		{
	...
	public void chatMessage(int red, int green, int blue, String inMessage)
	{
		...
		if (isPlayer())
		{
			...
			ListMessage msg = new ListMessage(DuskProtocol.MSG_CHAT);
			msg.add(new DuskMessage.IntegerMessage(0, red));
			msg.add(new DuskMessage.IntegerMessage(0, green));
			msg.add(new DuskMessage.IntegerMessage(0, blue));
			msg.add(new DuskMessage.StringMessage(0, inMessage));
			send(msg);
		}
		if (thnCharmer != null)
		{
	...
	boolean getPlayer()
	{
		try {
			...
			if (loadedPlayer != null) {
				...
				String enteredPassword = getNextStringMessageInput();
