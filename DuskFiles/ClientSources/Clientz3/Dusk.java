		...
		while(blnConnected)
		{
			try
			{
		        ...
		        case (DuskProtocol.MSG_UPDATE_MAP):
		        {
					synchronized(vctEntities)
					{
						String message = ((DuskMessage.StringMessage)msg).value;
				...
				{
					long ID = ((DuskMessage.LongMessage)msg).value;
					synchronized(vctEntities)
				{
				...
				synchronized(vctEntities)
				{
						...
						if (blnApplet)
						{
							sendMessage(new DuskMessage.StringMessage(DuskProtocol.MSG_COMMAND, "appletimages"));
						}else
						{
							sendMessage(new DuskMessage.StringMessage(DuskProtocol.MSG_COMMAND, "applicationimages"));
						}
						scaleWindow();
					}
					break;
