...
//		if (privs>1 || (batBattle == null && !blnSleep && engGame.canMoveTo(newLocX,newLocY,this)))
	...
	*/
	...
	public void updateOpponentHP(LivingThing opponent)
	{
		...
		{
			ListMessage msg = new ListMessage(MSG_UPDATE_OPPONENT_HP);
			msg.add(DuskMessage.create(FIELD_TARGET_ID, opponent.ID));
			msg.add(DuskMessage.create(FIELD_HP, opponent.hp));
			msg.add(DuskMessage.create(FIELD_MAXHP, opponent.maxhp));
			send(msg);
		}
	}
	...
	public void sendDamageSplat(long attackerID, long defenderID, int damage)
	{
		if (isPlayer() && blnWorking && !blnIsClosing)
		{
			ListMessage msg = new ListMessage(MSG_DAMAGE_SPLAT);
			msg.add(DuskMessage.create(FIELD_TARGET_ID, attackerID));
			msg.add(DuskMessage.create(FIELD_ENTITY_ID, defenderID));
			msg.add(DuskMessage.create(FIELD_DAMAGE, damage));
			send(msg);
		}
	}
	...
	public void updateMap()
	{
		...
		send(new MapMessage(MSG_UPDATE_MAP, intLocX, intLocY, tiles, tilesAlpha, tilesAlpha2));
	}
	...
	public void chatMessage(int red, int green, int blue, String inMessage)
	{
		...
		if (isPlayer())
		{
			...
			ListMessage msg = new ListMessage(MSG_CHAT_RGB);
			msg.add(DuskMessage.create(FIELD_RGB_R, red));
			msg.add(DuskMessage.create(FIELD_RGB_G, green));
			msg.add(DuskMessage.create(FIELD_RGB_B, blue));
			msg.add(DuskMessage.create(FIELD_STRING, inMessage));
			send(msg);
		}
		if (thnCharmer != null)
		{
...
//			}
	...
	public void updateEquipment()
	{
		try
		{
			ListMessage msg = new ListMessage(MSG_UPDATE_WORN);
			msg.add(DuskMessage.create(FIELD_WIELD, equWorn.wield != null ? equWorn.wield.strName : "none"));
			msg.add(DuskMessage.create(FIELD_ARMS, equWorn.arms != null ? equWorn.arms.strName : "none"));
			msg.add(DuskMessage.create(FIELD_LEGS, equWorn.legs != null ? equWorn.legs.strName : "none"));
			msg.add(DuskMessage.create(FIELD_TORSO, equWorn.torso != null ? equWorn.torso.strName : "none"));
			msg.add(DuskMessage.create(FIELD_WAIST, equWorn.waist != null ? equWorn.waist.strName : "none"));
			msg.add(DuskMessage.create(FIELD_NECK, equWorn.neck != null ? equWorn.neck.strName : "none"));
			msg.add(DuskMessage.create(FIELD_SKULL, equWorn.skull != null ? equWorn.skull.strName : "none"));
			msg.add(DuskMessage.create(FIELD_EYES, equWorn.eyes != null ? equWorn.eyes.strName : "none"));
			msg.add(DuskMessage.create(FIELD_HANDS, equWorn.hands != null ? equWorn.hands.strName : "none"));
			send(msg);
		}catch (Exception e)
		{
	...
	public void updateInfo()
	{
		try
		{
			ListMessage msg = new ListMessage(MSG_UPDATE_PLAYER);
			msg.add(DuskMessage.create(FIELD_HP, hp));
			msg.add(DuskMessage.create(FIELD_MAXHP, maxhp + hpbon));
			msg.add(DuskMessage.create(FIELD_MP, mp));
			msg.add(DuskMessage.create(FIELD_MAXMP, maxmp + mpbon));
			send(msg);
		}catch(Exception e)
		{
	...
	public void updateRange()
	{
		try
		{
			send(DuskMessage.create(MSG_UPDATE_RANGE, getRangeWithBonus()));
		}catch(Exception e)
		{
	...
	public void updateItems()
	{
		try
		{
			ListMessage msg = new ListMessage(MSG_UPDATE_INVENTORY);
			Item itmStore;
			LifoQueue qStore;
			Iterator iter=vctItems.keySet().iterator();
			while(iter.hasNext())
			{
				...
				if (qStore.size() > 0)
				{
					...
					if(itmStore.isArmor())
					{
						itemMsg.add(DuskMessage.create(FIELD_ENTITY_TYPE, 2 + itmStore.intKind));
					}else if (itmStore.isWeapon())
					{
						itemMsg.add(DuskMessage.create(FIELD_ENTITY_TYPE, 1));
					}else
					{
						itemMsg.add(DuskMessage.create(FIELD_ENTITY_TYPE, 0));
					}
					itemMsg.add(DuskMessage.create(FIELD_ENTITY_NAME, itmStore.strName));
					msg.add(itemMsg);
				}
			}
			send(msg);
	...
	public void updateStats()
	{
		try
		{
			ListMessage msg = new ListMessage(MSG_UPDATE_STATS);
			msg.add(DuskMessage.create(FIELD_CASH, cash));
			msg.add(DuskMessage.create(FIELD_EXP, exp));
			msg.add(DuskMessage.create(FIELD_STRENGTH, stre));
			msg.add(DuskMessage.create(FIELD_STRENGTH_BONUS, strebon));
			msg.add(DuskMessage.create(FIELD_INTELLIGENCE, inte));
			msg.add(DuskMessage.create(FIELD_INTELLIGENCE_BONUS, intebon));
			msg.add(DuskMessage.create(FIELD_DEXTERITY, dext));
			msg.add(DuskMessage.create(FIELD_DEXTERITY_BONUS, dextbon));
			msg.add(DuskMessage.create(FIELD_CONSTITUTION, cons));
			msg.add(DuskMessage.create(FIELD_CONSTITUTION_BONUS, consbon));
			msg.add(DuskMessage.create(FIELD_WISDOM, wisd));
			msg.add(DuskMessage.create(FIELD_WISDOM_BONUS, wisdbon));
			msg.add(DuskMessage.create(FIELD_DAMMOD, getDamMod()));
			msg.add(DuskMessage.create(FIELD_DAMMOD_BONUS, dammodbon));
			msg.add(DuskMessage.create(FIELD_AC, getArmorMod()));
			msg.add(DuskMessage.create(FIELD_AC_BONUS, acbon));
			...
			msg.add(DuskMessage.create(FIELD_CONDITIONS, conditions));
			...
			msg.add(DuskMessage.create(FIELD_SKILLS, skills));
			...
			msg.add(DuskMessage.create(FIELD_SPELLS, spells));

			if (thnMaster != null)
			{
				msg.add(DuskMessage.create(FIELD_FOLLOWING, thnMaster.strName));
			}
			if (thnFollowing != null)
			{
				msg.add(DuskMessage.create(FIELD_FOLLOWED_BY, thnFollowing.strName));
				if (thnFollowing.isPet())
				{
					msg.add(DuskMessage.create(FIELD_PET_HP, thnFollowing.hp));
					msg.add(DuskMessage.create(FIELD_PET_MAXHP, thnFollowing.maxhp + thnFollowing.hpbon));
				}
			}
			send(msg);
		}catch (Exception e)
